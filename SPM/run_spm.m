...
for i=1:size(Info,1) 
    ...
    system(cell2mat(strcat('mincresample -nearest -like /ipl/quarantine/models/icbm152_model_09c/mni_icbm152_t1_tal_nlin_asym_09c_outline.mnc',...
        {' '},'tmp/',Info.S(i),'_',Info.V(i),'.mnc',{' '},'tmp/',Info.S(i),'_',Info.V(i),'_2.mnc')));
    system(cell2mat(strcat('minc_qc.pl --mask /ipl/quarantine/models/icbm152_model_09c/mni_icbm152_t1_tal_nlin_asym_09c_outline.mnc --big',...
